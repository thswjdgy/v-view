...
**개발자(손정효)가 직접 검토·결정**하는 Human-in-the-Loop 방식으로 진행했습니다.
...
| 단계 | 사용 도구 | 산출물 | 검토 주체 |
|---|---|---|---|
| **기획(Plan)** | **Manifest AI** | 앱 컨셉·기능 정의·요구사항 초안 | 손정효 |
| **디자인(Design)** | **Google Stitch** | UI 화면 시안·디자인 시스템 | 손정효 |
| **개발(Develop)** | **Claude Code** | Flutter 코드·테스트·문서 | 손정효 |
| **검토(Review)** | 손정효 (개발자) | 최종 의사결정·품질 검수 | — |
