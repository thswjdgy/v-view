...
### 2.1 활용 방식 — 단계별 AI 도구 체인

분야별로 특화된 AI 도구를 조합하고, 모든 산출물은 **개발자가 직접 검토**했습니다.
...
| 단계 | AI 도구 | 개발자 역할 |
|---|---|---|
| 기획 | **Manifest AI** | 앱 컨셉·요구사항 검토·확정 |
| 디자인 | **Google Stitch** | UI 시안 검토·선택 |
| 개발 | **Claude Code** | 방향 설정 · 검증 · 의사결정 · 설명 |

단순한 코드 생성이 아닌 **대화형 개발 + 사람 검토(Human-in-the-Loop)** 방식을 채택했습니다.
